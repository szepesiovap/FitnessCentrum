...
public class OverenieHeslaForm2 extends javax.swing.JDialog {
    
    // tento formular je docasny, inak sa bude pouzivat overenieHeslaForm, len este musim zriesit, ako to urobim
    private Recepcny recepcny;
    private final RecepcnyDao recepcnyDao;

    public OverenieHeslaForm2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OverenieHeslaForm2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                OverenieHeslaForm2 dialog = new OverenieHeslaForm2(new javax.swing.JFrame(), true);
